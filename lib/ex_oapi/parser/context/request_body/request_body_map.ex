defmodule ExOAPI.Parser.V3.Context.RequestBody.Map do
  @behaviour Ecto.Type
  ...
  @type t() :: %{String.t() => Context.RequestBody.t()}
  ...
  def cast(data) when is_map(data) do
    Enum.reduce_while(data, {:ok, %{}}, fn
      {k, v}, {_, acc} when is_map(v) ->
        with changeset <- Context.RequestBody.map_cast(v),
