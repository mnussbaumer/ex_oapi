defmodule ExOAPI.Parser.V3.Context.Header.Map do
  @behaviour Ecto.Type
  ...
  @type t() :: %{String.t() => Context.Header.t()}
  ...
  def cast(data) when is_map(data) do
    Enum.reduce_while(data, {:ok, %{}}, fn {k, v}, {_, acc} ->
      with v_with_name <- Map.put(v, "name", k),
           changeset <- Context.Header.map_cast(v_with_name),
